...
import Founder1Img from '@/assets/Great_divide.png';
import Founder2Img from '@/assets/Olubiduu.png';
import ExecTiffanyImg from '@/assets/Tiffany.png';
import ExecMayImg from '@/assets/May.png';
import ExecPotatoImg from '@/assets/Potato.png';
import ExecYoleeImg from '@/assets/Yolee.png';
...
const EXECUTIVES = [
  { name: "Tiffany", title: "Head of Global Commerce", bio: "15年电商领域实战经验，曾任多家头部互联网企业高管，主导多个核心业务 from 0 to 1 的搭建与规模化增长，构建了集团品牌电商全球化运营体系", image: ExecTiffanyImg },
  { name: "May", title: "Head of IP Ecosystem", bio: "深耕IP商业生态，带领团队连续6年领跑国内综艺IP授权市场，打造多个IP行业标杆级联名案例，成功操盘S级以上IP项目上百个", image: ExecMayImg },
  { name: "Potato", title: "Executive Creative Director, IP", bio: "资深创意人，致力于IP项目创意视觉体系构建，带领团队从0到1孵化构建IP宇宙10+ ，搭建与设计服务多种IP娱乐消费品牌200+", image: ExecPotatoImg },
  { name: "Yolee", title: "Head of Corporate Strategy & Synergies", bio: "十余年互联网与高科技行业管理经验，在集团战略协作、市场品牌建设、政府关系、资本市场资源领域拥有深厚积淀，致力于构建集团内外双循环的战略生态", image: ExecYoleeImg },
];
